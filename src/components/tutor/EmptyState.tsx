...
import { FileUp, Camera, Mic, ArrowRight, MessageSquare, FileText } from "lucide-react";
    ...
    <div className="flex flex-col items-center justify-start h-full px-4 sm:px-6 pt-6 sm:pt-10 pb-24 sm:pb-28 gap-6 sm:gap-8 overflow-y-auto w-full max-w-3xl mx-auto">
      ...
      <div className="flex flex-col items-center text-center space-y-3 sm:space-y-4 animate-in-slide">
        ...
        <div>
          ...
          <h2 className="text-lg sm:text-xl text-primary font-medium mt-1">
      ...
      {/* Quick Actions */}
      <div
        className="grid grid-cols-3 gap-2 sm:gap-3 w-full animate-in-slide"
      ...
      >
        ...
        >
          <div
            className={`h-9 w-9 sm:h-10 sm:w-10 rounded-full flex items-center justify-center flex-shrink-0 ${isListening ? "bg-destructive/20 text-destructive" : "bg-accent/20 text-accent"}`}
          >
      ...
      <div className="w-full animate-in-slide" style={{ animationDelay: "200ms" }}>
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-2.5 sm:gap-3">
          ...
          >
            ...
            <span className="font-semibold text-sm">Summarize Notes</span>
          </Link>
        </div>
      </div>
