    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col justify-between overflow-x-hidden">
      ...
      <header className="border-b border-border/50 sticky top-0 bg-background/80 backdrop-blur-md z-30">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          <Link
            to="/"
            className="font-serif text-2xl font-black italic tracking-tight text-primary hover:opacity-90 transition-opacity"
          >
            GilaniAI
          </Link>
        ...
        <section className="mx-auto max-w-6xl px-6 py-16 sm:py-24 text-center sm:text-left grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7 animate-in-slide">
            ...
            <p className="mt-6 max-w-xl text-base sm:text-lg leading-relaxed text-muted-foreground text-balance">
              GilaniAI is curriculum-grounded. Upload study notes for instant summaries, practice
              custom revision quizzes, plan your revision calendars, and escalate questions directly
              to a real teacher when you need support.
            </p>
          ...
          <div className="lg:col-span-5 animate-in-slide [animation-delay:100ms] grid gap-4 w-full max-w-md mx-auto">
            ...
            >
              ...
              <div className="text-left flex-1 min-w-0">
                ...
                <p className="text-xs text-muted-foreground mt-0.5">
                  Revision planning, quizzes, and live chat assistance.
                </p>
              </div>
            ...
            >
              ...
              <div className="text-left flex-1 min-w-0">
                ...
                <p className="text-xs text-muted-foreground mt-0.5">
                  Manage escalations, view records, and help students.
                </p>
              </div>
              <ArrowRight className="h-4 w-4 text-muted-foreground group-hover:text-primary transition-colors" />
            </Link>
            ...
            >
              ...
              <div className="text-left flex-1 min-w-0">
                ...
                <p className="text-xs text-muted-foreground mt-0.5">
                  Configure system users, control roles, and view logs.
                </p>
              </div>
              <ArrowRight className="h-4 w-4 text-muted-foreground group-hover:text-primary transition-colors" />
            </Link>
        ...
        <section className="py-12 bg-muted/10 border-y border-border/40 overflow-hidden relative w-full">
          <div className="mx-auto max-w-6xl px-6 mb-6 text-center">
            ...
            <p className="text-xs text-muted-foreground mt-1">
              Pauses on hover. Scroll infinitely through our academic standards.
            </p>
          </div>
          <div className="relative w-full overflow-hidden py-1">
            <div className="flex gap-6 animate-marquee whitespace-nowrap">
              ...
              {SUBJECTS.map((sub, idx) => (
                <div
                  key={`sub1-${idx}`}
                  className="inline-flex items-center gap-3 px-5 py-3 rounded-2xl bg-card border border-border/60 shadow-sm select-none"
                >
            ...
            {[
              {
                i: MessageCircle,
                t: "Socratic AI Tutor",
                d: "Ask questions, get syllabus-grounded step-by-step guidance.",
              },
              {
                i: BookOpenText,
                t: "Notes Summarizer",
                d: "Upload local notes to produce immediate core takeaways.",
              },
              {
                i: Sparkles,
                t: "Practice Quizzes",
                d: "Dynamic revision tests targeting your weak conceptual zones.",
              },
              {
                i: ShieldCheck,
                t: "Human Teacher Review",
                d: "Easily flag low-confidence subjects for teacher escalation.",
              },
            ].map(({ i: Icon, t, d }) => (
              <div
                key={t}
                className="rounded-2xl border border-border/60 bg-card p-6 shadow-sm hover:border-primary/40 hover:shadow transition-all flex flex-col justify-between"
              >
                <div>
        ...
        <div className="mx-auto max-w-6xl px-6 py-16 grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
          ...
          <div className="md:col-span-4 space-y-4">
            ...
            <p className="text-xs text-muted-foreground leading-relaxed pr-4">
              Grounding academic performance in ethical assistance, step-by-step Socratic learning,
              and direct human teacher connectivity.
            </p>
          ...
          <div className="md:col-span-4 space-y-4 text-left">
            ...
            <div className="space-y-1.5 text-xs text-muted-foreground pt-1">
              <p className="flex items-center gap-2">
                <Mail className="h-3.5 w-3.5 text-primary" /> support@gilaniai.edu
              </p>
              <p className="flex items-center gap-2">
                <Phone className="h-3.5 w-3.5 text-primary" /> +254 700 000 000
              </p>
              <p className="flex items-center gap-2">
                <MapPin className="h-3.5 w-3.5 text-primary" /> Nairobi, Kenya
              </p>
            </div>
          </div>
        </div>
