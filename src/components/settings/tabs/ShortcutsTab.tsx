    ...
    <section className="rounded-2xl border border-border/40 bg-card p-4 sm:p-6 shadow-xs space-y-6 animate-in-slide">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="space-y-2">
          <p className="font-mono text-[10px] uppercase tracking-wider text-muted-foreground font-bold">Navigation</p>
          <div className="flex items-center justify-between p-3 rounded-xl border border-border/50 bg-background">
            ...
            <kbd className="px-2 py-1 bg-muted rounded border border-border text-[10px] font-mono text-muted-foreground shadow-sm">Ctrl + B</kbd>
          </div>
          <div className="flex items-center justify-between p-3 rounded-xl border border-border/50 bg-background">
            <span className="text-sm font-semibold text-foreground">New Chat</span>
            <kbd className="px-2 py-1 bg-muted rounded border border-border text-[10px] font-mono text-muted-foreground shadow-sm">Ctrl + N</kbd>
          </div>
        </div>

        <div className="space-y-2">
          <p className="font-mono text-[10px] uppercase tracking-wider text-muted-foreground font-bold">Chat Actions</p>
          <div className="flex items-center justify-between p-3 rounded-xl border border-border/50 bg-background">
            <span className="text-sm font-semibold text-foreground">Send Message</span>
            <kbd className="px-2 py-1 bg-muted rounded border border-border text-[10px] font-mono text-muted-foreground shadow-sm">Enter</kbd>
          </div>
          <div className="flex items-center justify-between p-3 rounded-xl border border-border/50 bg-background">
            <span className="text-sm font-semibold text-foreground">New Line</span>
            <kbd className="px-2 py-1 bg-muted rounded border border-border text-[10px] font-mono text-muted-foreground shadow-sm">Shift + Enter</kbd>
          </div>
        </div>
      </div>
    </section>
