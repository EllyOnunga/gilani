...
export function EscalationDetail({ esc, convoMessages, loadingMessages, answer, setAnswer, saving, onResolve, onCancel, variant = "inline" }: Props) {
  ...
  const wrapperClass = variant === "inline" ? "border-t border-border animate-in-slide" : "h-full flex flex-col";
    ...
    <div className={wrapperClass}>
      <div className="px-4 sm:px-5 pt-4 pb-3">
        ...
        {loadingMessages ? (
          ...
          <div className={`overflow-y-auto rounded-xl border border-border bg-muted/20 p-3 space-y-3 ${variant === "panel" ? "flex-1 min-h-[160px]" : "max-h-96"}`}>
