  ...
  public: {
    Tables: {
      ...
      global_note_chunks: {
        ...
        Relationships: [
          {
            foreignKeyName: "global_note_chunks_note_id_fkey"
            columns: ["note_id"]
            isOneToOne: false
            referencedRelation: "global_notes"
            referencedColumns: ["id"]
          },
        ]
      }
    ...
    Functions: {
      ...
      decrement_rate_limit: { Args: { p_key: string }; Returns: undefined }
      has_role: {
        Args: {
      ...
      increment_topup_tokens: {
        Args: { p_tokens: number; p_user_id: string }
        Returns: number
      }
      match_global_note_chunks:
        | {
      ...
      upsert_rate_limit: {
        Args: { p_key: string; p_max: number; p_reset_at: string }
        Returns: boolean
      }
    }
    Enums: {
