...
import type { Profile, Payment } from "@/client/components/admin/types";
import { formatDate } from "@/client/components/admin/types";
                ...
                {payments.map((pay) => (
                  ...
                  >
                    <td className="px-4 py-3">
                      ...
                      <p className="font-mono text-[10px] text-muted-foreground">
                        {pay.profiles?.email ?? (pay.user_id ? `${pay.user_id.slice(0, 8)}…` : "—")}
                      </p>
                    </td>
