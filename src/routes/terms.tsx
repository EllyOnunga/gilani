      ...
      <main className="flex-1 mx-auto w-full max-w-3xl px-4 sm:px-6 py-12 sm:py-20">
        ...
        <div className="prose prose-sm max-w-none space-y-8 text-sm leading-relaxed text-foreground/90">
          <Section title="1. Acceptance of Terms">
            <p>
              By accessing or using GilaniAI (&ldquo;the Service&rdquo;), you agree to be bound by
              these Terms of Service (&ldquo;Terms&rdquo;). If you do not agree, please do not use
              the Service. These Terms apply to all users, including students, teachers, and
              administrators.
            </p>
          </Section>
          ...
          <Section title="2. Description of Service">
            <p>
              GilaniAI provides an AI-powered academic tutoring and study platform designed for
              students following KCSE, CBC, and IGCSE curricula. The Service includes:
            </p>
            <ul>
          ...
          <Section title="3. User Accounts">
            <p>
              ...
              that occur under your account. You must be at least 13 years old to register
              independently. Users under 16 should have parental or guardian consent.
            </p>
            <p>
          ...
          <Section title="4. Acceptable Use">
            ...
            <ul>
              ...
              <li>
                Attempt to manipulate or abuse the AI system to generate harmful, illegal or
          ...
          <Section title="5. AI Limitations and Disclaimer">
            <p>
              ...
              strive for curriculum accuracy, <strong>AI responses may contain errors</strong>. The
              Service is designed to support — not replace — human teaching. Students should verify
              critical information with their teachers or official textbooks, especially for
              high-stakes examinations.
            </p>
            <p>
              GilaniAI does not guarantee exam results or academic performance outcomes. The quality
              of responses depends on the curriculum information and exam standards available to the
              AI at the time of training.
            </p>
          </Section>
          ...
          <Section title="6. Teacher Escalation">
            <p>
              ...
              is shared with the verified teacher assigned to the student&apos;s school or
              institution. Regular AI conversations remain private and are not shared with teachers
              unless explicitly escalated by the student.
            </p>
            <p>
              Teachers using the escalation portal agree to respond professionally and in accordance
              with Kenyan educational standards and ethics.
            </p>
          </Section>

          <Section title="7. Intellectual Property">
            <p>
              All content generated by GilaniAI&apos;s AI systems (summaries, flashcards, quiz
              questions, study plans) is provided for your personal educational use only. You may
              not resell, redistribute or publish this content commercially without written
              permission.
            </p>
            <p>
              Notes and content you upload remain your intellectual property. By uploading, you
              grant GilaniAI a limited licence to process that content solely to provide the Service
              to you.
            </p>
          </Section>
          ...
          <Section title="8. Subscription and Payments">
            <p>
              ...
              has not been materially used during that period.
            </p>
          </Section>
          ...
          <Section title="9. Termination">
            <p>
              ...
              in fraudulent activity, or abuse the AI system. You may close your account at any time
