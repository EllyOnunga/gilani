    ...
    case "galileo":
      return (
        <svg viewBox="0 0 32 32" className="h-full w-full bg-gradient-to-br from-blue-500 to-blue-700 p-2 text-white">
          ...
          <path d="M16 4v24M4 16h24M16 4c-4 0-8 5.373-8 12s4 12 8 12 8-5.373 8-12S20 4 16 4z" stroke="currentColor" strokeWidth="1" fill="none" />
        </svg>
      );
    case "lovelace":
      return (
        <svg viewBox="0 0 32 32" className="h-full w-full bg-gradient-to-br from-purple-500 to-purple-700 p-2 text-white">
          ...
          <path d="M12 12h8M12 16h8M12 20h4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
        </svg>
      );
    case "hypatia":
      return (
        <svg viewBox="0 0 32 32" className="h-full w-full bg-gradient-to-br from-rose-500 to-rose-700 p-2 text-white">
          <path d="M16 6L6 26h20L16 6z" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" />
          <circle cx="16" cy="18" r="4" fill="none" stroke="currentColor" strokeWidth="1.5" />
        </svg>
      );
    case "einstein":
      return (
        <svg viewBox="0 0 32 32" className="h-full w-full bg-gradient-to-br from-slate-500 to-slate-700 p-2 text-white">
          <path d="M8 22c0-4 4-6 8-6s8 2 8 6" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
          <circle cx="16" cy="10" r="4" fill="none" stroke="currentColor" strokeWidth="1.5" />
          <path d="M12 10c-2-2-4 0-4 0s0-3 2-4M20 10c2-2 4 0 4 0s0-3-2-4" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
        </svg>
      );
    default:
      return null;
