...
function AuthedShell() {
  ...
  return (
    <div className="flex h-screen w-full flex-col overflow-hidden lg:flex-row bg-background text-foreground">
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-50 flex w-64 flex-col border-r border-border bg-sidebar p-6 transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:h-screen overflow-hidden rounded-r-2xl ${
                        ...
                        return (
                          ...
                          >
                            ...
                            <button
                              ...
                              className="opacity-100 sm:opacity-0 sm:group-hover:opacity-100 p-1 rounded-md hover:bg-destructive/10 text-muted-foreground hover:text-destructive transition-all flex-shrink-0"
                              title="Delete chat"
                            >
