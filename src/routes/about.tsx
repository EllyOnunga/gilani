    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-3xl px-6 py-16 prose-styles">
        ...
        <ul className="mt-4 space-y-4 text-muted-foreground">
          <li><span className="font-semibold text-foreground">Scout</span> — keeps revision rhythms steady: streaks, exam countdowns, gentle nudges.</li>
          <li><span className="font-semibold text-foreground">Guardian</span> — the tutoring engine: summarization, explanation, quiz generation, all grounded in your uploaded notes.</li>
          <li><span className="font-semibold text-foreground">Hunter</span> — the ethics layer: when a response is low-confidence or a student shows distress, an escalation is created for a teacher.</li>
        </ul>
