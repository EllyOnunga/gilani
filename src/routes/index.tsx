            ...
            <div className="flex flex-wrap justify-center gap-5 items-stretch">
              {Object.values(PLANS).map((plan) => {
                ...
                return (
                  <div
                    key={plan.id}
                    className={`relative rounded-2xl flex flex-col justify-between w-full sm:w-[calc(50%-10px)] lg:w-[calc(25%-15px)] min-w-[220px] max-w-[290px] p-6 transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl ${
                      isPremium
