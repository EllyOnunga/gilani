...
export const Route = createFileRoute("/cookies")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "GilaniAI's Cookie Policy — how we use cookies and similar technologies for authentication, preferences, and analytics.",
      },
    ],
  }),
        ...
        <div className="space-y-8 text-sm leading-relaxed">
          <Section title="1. What Are Cookies?">
            <p>
              ...
              websites to remember your preferences, keep you logged in, and understand how you use
              the service. GilaniAI uses cookies and similar browser storage technologies (such as
              localStorage) to provide a reliable, personalised experience.
            </p>
          </Section>
          ...
          <Section title="2. Types of Cookies We Use">
            ...
            <ul>
              <li>
                <strong>Essential cookies:</strong> Required for the Service to function. Without these,
                features like login and session management would not work.
              </li>
              <li>
              ...
              <li>
                <strong>Analytics cookies:</strong> Collect anonymous, aggregated data on how
                users interact with GilaniAI to help us improve the platform. These cookies do not
              ...
              <table className="w-full min-w-[500px] border-collapse text-[11px] mt-3">
                <thead>
                  <tr className="border-b border-border bg-muted/30">
                    <th className="text-left font-mono font-bold p-3 text-muted-foreground uppercase tracking-wider">Cookie</th>
                    <th className="text-left font-mono font-bold p-3 text-muted-foreground uppercase tracking-wider">Type</th>
                    <th className="text-left font-mono font-bold p-3 text-muted-foreground uppercase tracking-wider">Purpose</th>
                    <th className="text-left font-mono font-bold p-3 text-muted-foreground uppercase tracking-wider">Duration</th>
                    <th className="text-left font-mono font-bold p-3 text-muted-foreground uppercase tracking-wider">Opt-out?</th>
                  </tr>
                </thead>
                <tbody>
          ...
          <Section title="5. Managing Cookies">
            ...
            <ul>
              <li>
                ...
                via Settings → Privacy. Note that blocking essential cookies will prevent you from
                staying logged in.
              </li>
              <li>
              ...
              <li>
                <strong>Opt-out of analytics:</strong> If we add an analytics opt-out toggle, it will
                appear in your account settings. Opting out sets a preference cookie that instructs
                our analytics system to ignore your sessions.
              </li>
            </ul>
            <p>
              Please note: disabling essential cookies will prevent you from accessing your account.
              Preference and functional cookies only affect your personal experience and do not share
          ...
          <Section title="6. localStorage and sessionStorage">
            <p>
              In addition to cookies, GilaniAI uses browser localStorage to store your theme preference
              (light/dark mode) and disclaimer acknowledgement. This data is stored only on your device
              and is never transmitted to our servers. You can clear it via your browser&apos;s developer
              tools or by clearing site data.
            </p>
          </Section>
          ...
          <Section title="8. Updates to This Policy">
            <p>
              ...
              change. The &ldquo;Last updated&rdquo; date at the top indicates when this policy was most
              recently revised. We will notify registered users of significant changes.
            </p>
          </Section>
