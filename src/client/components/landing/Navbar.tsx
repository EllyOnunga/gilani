          ...
          <div className="hidden md:flex items-center gap-2">
            {SOCIAL_LINKS.map((s) => (
              <a
                ...
                aria-label={s.label}
                className="inline-flex h-8 w-8 items-center justify-center rounded-md text-white/50 hover:text-white hover:bg-white/5 transition-colors"
              >
                {s.icon}
              </a>
            ))}
                ...
                <div className="flex items-center justify-center gap-4 pb-1">
                  {SOCIAL_LINKS.map((s) => (
                    <a
                      ...
                      rel="noopener noreferrer"
                      aria-label={s.label}
                      className="inline-flex h-10 w-10 items-center justify-center rounded-lg text-white/50 hover:text-white hover:bg-white/5 active:bg-white/10 transition-colors"
                    >
                      {s.icon}
                    </a>
                  ))}
