      ...
      <div className="mx-auto max-w-7xl px-6 py-16 md:py-20 grid grid-cols-2 gap-x-8 gap-y-12 md:grid-cols-12">
        ...
        <div className="col-span-2 flex flex-col gap-4 md:col-span-4">
          ...
          <div className="flex items-center gap-4 text-[#C96A3D] mt-2">
            ...
            <a href="#" className="hover:text-[#E28743] transition-colors">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.894 8.221l-1.97 9.28c-.145.658-.537.818-1.084.508l-3-2.21-1.446 1.394c-.14.18-.357.223-.548.223l.188-2.85 5.18-4.68c.223-.198-.054-.31-.346-.116l-6.405 4.02-2.76-.86c-.6-.188-.616-.605.126-.894l10.77-4.148c.5-.188.94.116.805.895z" />
              </svg>
            </a>
          </div>
        </div>
        ...
        <div className="col-span-2 flex flex-col gap-4 md:col-span-4">
          ...
          {subscribed ? (
            <div className="text-sm text-emerald-500 font-medium">Thanks for subscribing!</div>
          ) : (
