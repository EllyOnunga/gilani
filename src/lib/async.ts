...
const ERROR_PATTERNS: Array<{ test: RegExp | string; message: string }> = [
  ...
  },
  {
    ...
    message: "Your request is too long for the AI to process. Try a shorter input.",
  },
  {
    test: /content policy/i,
    message: "Your request couldn't be processed due to content guidelines.",
  },
  {
    test: /quota exceeded/i,
    message: "AI quota exceeded. Please try again later or upgrade your plan.",
  },
  {
    test: /overloaded/i,
